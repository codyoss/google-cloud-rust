...
impl BucketIamConfigurationBuilder {
    ...
    /// The bucket's uniform bucket-level access configuration.
    pub fn uniform_bucket_level_access(mut self, value: BucketIamConfigurationUniformBucketLevelAccess) -> Self {
...
impl ComposeRequestSourceObjectsBuilder {
    ...
    /// Conditions that must be met for this operation to execute.
    pub fn object_preconditions(mut self, value: ComposeRequestSourceObjectsObjectPreconditions) -> Self {
